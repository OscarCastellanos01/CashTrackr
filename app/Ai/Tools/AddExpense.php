...
class AddExpense implements Tool
{
    ...
    public function description(): Stringable|string
    {
        if(!$this->hasCategories) {
            return 'Agrega un nuevo gasto al presupuesto actual, requiere nombre, monto y categoria';
        }

        return 'Agrega un nuevo gasto al presupuesto actual, requiere nombre y monto. La categoria no aplica para este tipo de presupuesto';
    }
