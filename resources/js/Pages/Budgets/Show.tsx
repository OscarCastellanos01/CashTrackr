        ...
        <>
            ...
            <section className="p-10 lg:px-5 shadow-lg mt-10">
                                ...
                                <tbody className="divide-y divide-gray-300 ">
                                    ...
                                    <tr key={expense.id} className="flex justify-between items-center ">
                                        <td className={`${budget.type === 'general' ? 'pt-10' : 'pt-5' } pb-5 px-10 relative`}>
                                            {budget.type === "general" &&
                                            (
                                                <p className={`absolute top-0 left-0 inline-block px-3 py-1 rounded-br-2xl text-sm
                                                    font-medium w-40 ${expense.category_color}`}>
                                                    {
                                            ...
                                            <p className="text-sm text-gray-400">
                                                Agregado el: {formatDate(expense.created_at)}
                                            </p>
                                        </td>
                ...
                <p className="text-center text-xl mt-10 ">
                    No Hay Gastos.
                    <button type="button" onClick={openCreateModal} className="text-amber-500">
